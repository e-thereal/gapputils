...
const QMetaObject gapputils::host::LogbookModel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_gapputils__host__LogbookModel,
      qt_meta_data_gapputils__host__LogbookModel, 0 }
};
...
int gapputils::host::LogbookModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: newMessage((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< const std::string(*)>(_a[2])),(*reinterpret_cast< const std::string(*)>(_a[3])),(*reinterpret_cast< const std::string(*)>(_a[4]))); break;
        default: ;
        }
        _id -= 1;
    }
