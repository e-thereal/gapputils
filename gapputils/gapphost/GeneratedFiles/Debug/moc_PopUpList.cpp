...
void gapputils::host::PopUpList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData gapputils::host::PopUpList::staticMetaObjectExtraData = {
...
const QMetaObject gapputils::host::PopUpList::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_gapputils__host__PopUpList,
      qt_meta_data_gapputils__host__PopUpList, &staticMetaObjectExtraData }
};
