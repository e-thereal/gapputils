...
**
** Created: Tue Jul 10 20:12:54 2012
...
const QMetaObject gapputils::host::WorkflowToolBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_gapputils__host__WorkflowToolBox,
      qt_meta_data_gapputils__host__WorkflowToolBox, 0 }
};
...
int gapputils::host::WorkflowToolBox::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: focusFilter(); break;
        case 1: filterToolBox((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: itemClickedHandler((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 3;
    }
