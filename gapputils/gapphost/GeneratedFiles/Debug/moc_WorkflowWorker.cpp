...
**
** Created: Thu May 12 21:00:32 2011
...
static const char qt_meta_stringdata_gapputils__workflow__WorkflowWorker[] = {
    ...
    "\0node\0moduleUpdated(Node*)\0node,i\0"
    "progressed(Node*,int)\0updateModule(Node*)\0"
};
...
int gapputils::workflow::WorkflowWorker::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: moduleUpdated((*reinterpret_cast< Node*(*)>(_a[1]))); break;
        case 1: progressed((*reinterpret_cast< Node*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: updateModule((*reinterpret_cast< Node*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 0
void gapputils::workflow::WorkflowWorker::moduleUpdated(Node * _t1)
{
...
// SIGNAL 1
void gapputils::workflow::WorkflowWorker::progressed(Node * _t1, int _t2)
{
