...
int main(int argc, char *argv[])
{
  ...
  try {
    ...
    if (boost::filesystem::exists(DataModel::AutoSaveName) && !model.getHeadless() &&
        QMessageBox::question(0, "Crash detected.",
            "It seems grapevine didn't exit properly or is still running. Do you want to load the last automatically saved configuration?",
