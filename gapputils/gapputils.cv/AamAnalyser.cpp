...
BeginPropertyDefinitions(AamAnalyser)
  ...
  DefineProperty(FocalShapeParameters, Input("FSP"), Volatile(), Hide(), Observe(PROPERTY_ID), TimeStamp(PROPERTY_ID))
  DefineProperty(StartShapeParameters, Input("SSP"), Volatile(), Hide(), Observe(PROPERTY_ID), TimeStamp(PROPERTY_ID))
  DefineProperty(TargetShapeParameters, Input("TSP"), Volatile(), Hide(), Observe(PROPERTY_ID), TimeStamp(PROPERTY_ID))
//  DefineProperty(PlotDirection, Enumerable<vector<double>, false>(), Observe(PROPERTY_ID), TimeStamp(PROPERTY_ID))
  ...
  DefineProperty(SsdRef, Observe(PROPERTY_ID), TimeStamp(PROPERTY_ID))
  DefineProperty(MiRef, Observe(PROPERTY_ID), TimeStamp(PROPERTY_ID))
  DefineProperty(SsdImg, Observe(PROPERTY_ID), TimeStamp(PROPERTY_ID))
  DefineProperty(MiImg, Observe(PROPERTY_ID), TimeStamp(PROPERTY_ID))
