...
**
** Created: Wed Jul 25 13:46:25 2012
...
void gapputils::cv::GridDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData gapputils::cv::GridDialog::staticMetaObjectExtraData = {
...
const QMetaObject gapputils::cv::GridDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_gapputils__cv__GridDialog,
      qt_meta_data_gapputils__cv__GridDialog, &staticMetaObjectExtraData }
};
