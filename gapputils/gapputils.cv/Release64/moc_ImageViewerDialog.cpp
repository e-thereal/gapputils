...
**
** Created: Wed Oct 10 14:26:52 2012
...
void gapputils::cv::ImageViewerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData gapputils::cv::ImageViewerWidget::staticMetaObjectExtraData = {
...
const QMetaObject gapputils::cv::ImageViewerWidget::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_gapputils__cv__ImageViewerWidget,
      qt_meta_data_gapputils__cv__ImageViewerWidget, &staticMetaObjectExtraData }
};
...
void gapputils::cv::ImageViewerDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData gapputils::cv::ImageViewerDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};
...
const QMetaObject gapputils::cv::ImageViewerDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_gapputils__cv__ImageViewerDialog,
      qt_meta_data_gapputils__cv__ImageViewerDialog, &staticMetaObjectExtraData }
};
