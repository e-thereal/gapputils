...
BeginPropertyDefinitions(CorrelationTensor, Renamed("gml::imageprocessing::CorrelateTensor"), Deprecated("Use gml::imageprocessing::CorrelateTensor instead."), Description("Calculates the correlation of an input vector with each element of a vector of tensors."))
