...
#ifndef _CULIB_MATH3D_H_
#define _CULIB_MATH3D_H_
...
inline __host__ __device__ fmatrix4 make_fmatrix4_scaling(float x = 1, float y = 1, float z = 1) {
...
// multiplication
inline __host__ __device__ float4 operator*(fmatrix4 a, float4 b) {
